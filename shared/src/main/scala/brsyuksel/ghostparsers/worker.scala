...
import brsyuksel.ghostparsers.content.{ reader => R }
import brsyuksel.ghostparsers.content.{ matcher => M }
import brsyuksel.ghostparsers.content.{ writer => W }
import brsyuksel.ghostparsers.{ processor => P, scripting => S }
